...
# Load Model
embedding_model = ko.FF_AE([264,1000,1000,100], [100,1000,1000,264],E_dropout_rates= [0.5,0.5,0,0],activation_fn='leaky_relu')
...
TestingKoopnondelay.fit(train_dataloader, test_dataloader, runconfig=runconfig,
                         ...
                         loss_weights = [1,0.5,1,1,0.0001,1], mask_value=mask_value,
                        ...
                        learning_rate_change=0.8, early_stop=True, patience=100,
                         baseline=baseline, grad_clip=0, weight_decay=0.0)
