...
# Load Model
embedding_model = ko.FF_AE([264,150,150,150,150,150,150,100], [100,150,150,150,150,150,150,264],E_dropout_rates= [0,0.3,0,0,0,0,0,0],activation_fn='leaky_relu')
...
TestingKoopnondelay.fit(train_dataloader, test_dataloader, runconfig=runconfig,
                         num_epochs = 300, lr=0.0001, max_Kstep=1,
